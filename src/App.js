...
const apiEndpointsTRFA = {
  upsincm1data: "http://localhost:8000/mod1/api/upsincm1data/",
  upsincm2data: "http://localhost:8000/mod1/api/upsincm2data/",
  upsincm3data: "http://localhost:8000/mod1/api/upsincm3data/",
  upsincm4data: "http://localhost:8000/mod1/api/upsincm4data/",
  upsincm5data: "http://localhost:8000/mod1/api/upsincm5data/",
  cellltpanel1data: "http://localhost:8000/pcc1/api/cellltpanel1data/",
  chiller2data: "http://localhost:8000/pcc1/api/chiller2data/",
  celltoolpdb2data: "http://localhost:8000/pcc1/api/celltoolpdb2data/",
};

const apiEndpointsTRFB = {
  ups1incomer1data: "http://localhost:8000/cell1/api/ups1incomer1data/",
  ups1incomer2data: "http://localhost:8000/cell1/api/ups1incomer2data/",
  ups1incomer3data: "http://localhost:8000/cell1/api/ups1incomer3data/",
  ups1incomer4data: "http://localhost:8000/cell1/api/ups1incomer4data/",
  ups1incomer5data: "http://localhost:8000/cell1/api/ups1incomer5data/",
  ups1ltpanel1data: "http://localhost:8000/cell1/api/ups1ltpanel1data/",
  cellltpanel1data: "http://localhost:8000/cell1/api/cellltpanel1data/",
  celltoolpdb2data: "http://localhost:8000/pcc1/api/celltoolpdb2data/",
};
