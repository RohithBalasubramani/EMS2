...
const Anomaly = () => {
  ...
  const apiEndpoints = {
    amf1dailykwhanomalydb:
      "http://localhost:8000/anomaly/api/amf1dailykwhanomalydb/",
    amf2dailykwhanomalydb:
      "http://localhost:8000/anomaly/api/amf2dailykwhanomalydb/",
  };
    ...
    try {
      ...
      if (endpoint === "amf1dailykwhanomalydb") {
        const additionalResponse = await axios.get(
          "http://localhost:8000/api/amf1dailykwh/"
        );
        ...
        const additionalResponse = await axios.get(
          "http://localhost:8000/api/amf2dailykwh/"
        );
        setAdditionalData(additionalResponse.data); // Set the additional data state (modify this as per your requirement)
      }
    } catch (error) {
